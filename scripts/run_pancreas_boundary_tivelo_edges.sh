...
JOB_NAME="${JOB_NAME:-velovi-pancreas-boundary-tivelo}"
...
OUTPUT_DIR="${OUTPUT_DIR:-${WORKSPACE}/results/velovi_pancreas_boundary_tivelo}"
...
runai-bgu submit cmd \
  ...
  -- "
    python -m scvi.experimental.velovi_improvements.runner \
      ...
      --wandb-run-group \"pancreas_boundary_tivelo\" \
