...
JOB_NAME="${JOB_NAME:-velovi-organoids-transformer}"
...
OUTPUT_DIR="${OUTPUT_DIR:-${WORKSPACE}/results/velovi_organoids_transformer}"
...
# Note: This dataset is not registered in VELOVI_DATASETS by default. Ensure the
# corresponding DatasetConfig has been added if you plan to use this script.
