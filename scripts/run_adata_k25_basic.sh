...
JOB_NAME="${JOB_NAME:-velovi-adata-k25}"
...
OUTPUT_DIR="${OUTPUT_DIR:-${WORKSPACE}/results/velovi-adata-k15}"
...
runai-bgu submit cmd \
  ...
  -- "
   python -m scvi.experimental.velovi_improvements.runner \
          ...
          --transformer-weight-smooth 0.1e-1 \
          ...
          --transformer-weight-celltype 1.0 \
