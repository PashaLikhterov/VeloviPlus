...
JOB_PREFIX="${JOB_PREFIX:-velovi-transformer-boundary}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${WORKSPACE}/results/velovi_boundary_grid}"
...
RUN_GROUP_PREFIX="${RUN_GROUP_PREFIX:-boundary_transformer}"
...
for DATASET in "${DATASETS[@]}"; do
    ...
    RUN_GROUP="${RUN_GROUP_PREFIX}_${DATASET}"

    echo "[VELOVI] Submitting job ${JOB_NAME} for dataset ${DATASET}"
